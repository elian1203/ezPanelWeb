                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="checkbox" name="admin-permission" id="admin-permission"
                                       onclick="adminClicked(this)"
                                    <?php
                        ...
                        <button type="submit" class="btn btn-primary form-control" onclick="return validateUserForm();">
                            Save
                        </button>
                    </form>
                </div>
